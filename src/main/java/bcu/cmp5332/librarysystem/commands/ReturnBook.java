...
/**
 * The ReturnBook class represents a command to return a loaned book to the library.
...
public class ReturnBook implements Command {
	...
	/**
	 * Execute the Command to return a book to the library
	 * 
	...
	public void execute(Library library, LocalDate currentDate) throws LibraryException {
		...
		try {
            if (originalLoan != null) {
                ...
                originalLoan.setReturnDate(currentDate);
                originalLoan.setTerminated(true);
